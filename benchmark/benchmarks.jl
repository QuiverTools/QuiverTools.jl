...
Runs the function f with the arguments in setups[f] and clears the cache of f afterwards.
...
functions = vcat(
  functions_batch_0, functions_batch_1, functions_batch_2, functions_batch_3
);
